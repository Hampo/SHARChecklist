...
namespace SHARChecklist
{
    public partial class FrmMain : Form
    {
        ...
        private void TmrUpdate_Tick(object sender, EventArgs e)
        {
            ...
            using (SHARMemory SHARMem = new SHARMemory(SHAR))
            {
                if ((int)SHARMem._GameState < 2)
                {
                    resetStats();
                }
                else
                {
                    uint LevelCount = S == null ? 7 : S.LevelCount;
        ...
        private void setLevelCountToolStripMenuItem_Click(object sender, EventArgs e)
        {
            using (FrmSetLevelCount frm = new FrmSetLevelCount())
            {
                frm.ShowDialog();
            }
        }
